...
结算时，先会把硬币赚的钱加上去，然后应用5%的自动增长，但这两个过程之间几乎没有间隔，稍不注意可能会被认为是bug，如果刚好是大回合末就会自动扣除债务

进入下一个大回合解锁通道之后债务才会更新

只有第一大回合的第一小回合结算会显示弹窗“第1小回合结束”，其他大回合的第一小回合只会在结尾显示弹窗“第x大回合第1小回合结束”

点进了推币机近景就不能切换场景了

贷款会在还贷期限后自动扣除普通币，届时没有被消费的贷款币也会被收回，所有要多多消费哦

商店的刷新实际上是有次数限制的，由于默认玩家可以在遍历所有物品一遍的情况下能找到自己想要的物品，商店遍历完一次就不会刷新重复，购买物品之后货架会往前移，空出最后一格，有的物品购买即生效比如免费刷新卷
